...
@if(!$disableConsentModalHere && (($site?->cookie_banner_enabled ?? false) && !empty($site?->cookie_banner_html)))
    ...
    (function () {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const already = getCookie(CONSENT_COOKIE);
            ...
            document.getElementById('cookieRejectBtn')?.addEventListener('click', function () {
                ...
                // Opzionale: forziamo l'update denied per far vedere l'evento a Google
                if (typeof gtag === 'function') {
                    gtag('consent', 'update', {
                        'ad_storage': 'denied',
