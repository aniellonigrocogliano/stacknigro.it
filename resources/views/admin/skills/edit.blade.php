      ...
      <div class="card-body">
        <form method="POST" action="{{ route('admin.skills.update', $skill) }}">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="color" class="form-control" value="{{ old('color', $skill->color) }}">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="fa_icon" class="form-control" value="{{ old('fa_icon', $skill->fa_icon) }}">
          ...
          <div class="mb-3">
            ...
            <input type="number" name="sort" class="form-control" value="{{ old('sort', $skill->sort) }}" min="0">
            @error('sort') <div class="mt-1 text-xs text-danger">{{ $message }}</div> @enderror
          </div>

          <button class="btn bg-gradient-dark" type="submit">Aggiorna</button>
