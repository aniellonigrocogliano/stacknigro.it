...
@section('title', 'Modifica opzione')
...
<div class="py-4 container-fluid">
  ...
  <div class="mb-4 d-flex align-items-center justify-content-between">
    <div>
      <h4 class="mb-0">Modifica opzione</h4>
      <p class="mb-0 text-sm text-secondary">
        Aggiorna dati, range ore e range prezzo.
      </p>
    </div>
  ...
  <form method="POST" action="{{ route('admin.quote-options.update', $quoteOption) }}">
    @csrf
    @method('PUT')
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input type="text"
                     name="label"
                     class="form-control"
                     value="{{ old('label', $quoteOption->label) }}"
                     required>
            </div>
            ...
            <div class="mb-3">
              ...
              <textarea name="help_text"
                        class="form-control"
                        rows="3"
                        placeholder="Testo di supporto/descrizione">{{ old('help_text', $quoteOption->help_text) }}</textarea>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="m-0 form-check form-switch">
                <input class="form-check-input"
                       ...
                       name="is_active"
                       value="1"
                       {{ old('is_active', $quoteOption->is_active ?? 1) ? 'checked' : '' }}>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="number"
                       ...
                       class="form-control"
                       min="0"
                       value="{{ old('hours_min', $quoteOption->hours_min) }}">
              </div>
              ...
              <div class="col-md-6">
                ...
                <input type="number"
                       ...
                       class="form-control"
                       min="0"
                       value="{{ old('hours_max', $quoteOption->hours_max) }}">
              </div>
            </div>
            ...
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <input type="number"
                       ...
                       class="form-control"
                       min="0"
                       value="{{ old('price_min', $quoteOption->price_min) }}">
              </div>
              ...
              <div class="col-md-6">
                ...
                <input type="number"
                       ...
                       class="form-control"
                       min="0"
                       value="{{ old('price_max', $quoteOption->price_max) }}">
              </div>
            </div>
